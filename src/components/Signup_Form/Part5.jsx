...
return(
    <>
      <div id="part-5" className="pt-2 ps-5 pb-5 pe-5"  >
          ...
          <button onClick={handleOnChangeBack} id="btn-5b" type="button" class="btn btn-primary "  >Back</button>
          <button onClick={handleOnChangeNext} id="btn-5" type="button" class="btn btn-primary ms-2  " disabled={tog}>Select Salary</button>
        </div>
    </>
);
};
